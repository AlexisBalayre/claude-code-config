...
# Block: generated route tree
if echo "$FILE_PATH" | grep -qE 'routeTree\.gen\.ts$'; then
  echo "BLOCKED: routeTree.gen.ts is auto-generated by TanStack Router. Do not edit manually." >&2
  exit 2
fi
...
if echo "$FILE_PATH" | grep -qE 'packages/acme-rpc/src/generated/'; then
  echo "BLOCKED: gRPC stubs are auto-generated. Edit .proto files and run 'pnpm --filter @acme/acme-rpc proto:gen' instead." >&2
  exit 2
fi
