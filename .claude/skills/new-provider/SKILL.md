...
Scaffold a new delivery Provider. The adapter/factory/registry obligations are in `docs/conventions/services.md` §Delivery Providers, injected by the services rule as soon as you Read a file under `packages/acme-providers/`; this skill is the execution checklist.
