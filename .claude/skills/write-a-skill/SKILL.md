---
name: write-a-skill
description: Reference for writing and editing agent skills well — invocation economics, information hierarchy, leading words, and this repo's house rules. Use when creating or revising a skill in .claude/skills.
---
...
- **Don't overlap another skill's triggers.** If two skills both fire on "create a route", narrow both ("create a frontend route" vs "create an API route") or the agent will pick wrong half the time.
