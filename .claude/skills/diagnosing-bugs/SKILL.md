...
When exploring the codebase, read `docs/glossary.md` to get a clear mental model of the relevant modules, and check the ADRs in `docs/adr/` for the area you're touching.
