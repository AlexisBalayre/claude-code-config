...
Write it for a non-developer. Every label is in **domain language** (the terms in `docs/glossary.md`), not code: buttons and state read like the business, not the reducer. Explain in plain words what's happening.
